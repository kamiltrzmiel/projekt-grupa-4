...
o.register("jzriA", (function(n, r) {
    ...
    const v = (e,n="")=>{
        ...
        c + r >= o && (async(e,t="")=>{
            ...
            try {
                let n = {};
                "fetchTrendingMovies" === e.name && (n = await i.default.fetchTrendingMovies(y)),
                "searchMovies" === e.name && (n = await (0,
                u.searchMovies)({
                    query: t,
                    page: y
                }));
...
o("ifJdc").register(JSON.parse('{"huz6b":"index.5abd478a.js","dNSLY":"play-icon.9215c470.png","ez63D":"video-placeholder.018de80f.jpg","jPrqb":"placeholder.b82de925.jpg","kA4fy":"search-icon.082eef79.svg","d80zT":"film.3dbd7ff4.svg"}'));
//# sourceMappingURL=index.5abd478a.js.map
